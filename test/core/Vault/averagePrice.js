...
let pyth;
  ...
  it("position.averagePrice, buyPrice != markPrice", async () => {
    ...
    expect(await zlpManager.getAumInUsdg(false)).eq("103181083000000000000") // 102.203938
    expect(await zlpManager.getAumInUsdg(true)).eq("103181083000000000000") // 102.740698
  ...
  it("position.averagePrice, buyPrice == markPrice", async () => {
    ...
    expect(await zlpManager.getAumInUsdg(false)).eq("102200275000000000000") // 102.202981
    expect(await zlpManager.getAumInUsdg(true)).eq("102200275000000000000") // 102.202981
    ...
    expect(await zlpManager.getAumInUsdg(false)).eq("102200781000000000000") // 102.203487
    expect(await zlpManager.getAumInUsdg(true)).eq("102200781000000000000") // 102.203487
