...
contract Vault is ReentrancyGuard, IVault {
    ...
    IBlockInfo public override blockInfo;
    ...
    constructor(address _delegatePartOne, address _delegatePartTwo, address _delegatePartThree, IBlockInfo _blockInfo) public {
        gov = msg.sender;
    ...
    function getDelta(address _indexToken, uint256 _size, uint256 _averagePrice, bool _isLong, uint256 _lastIncreasedTime) public override view returns (bool, uint256) {
        ...
        uint256 minBps = blockInfo.getBlockTimestamp() > _lastIncreasedTime.add(minProfitTime) ? 0 : minProfitBasisPoints[_indexToken];
