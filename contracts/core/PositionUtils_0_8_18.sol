...
library PositionUtils_0_8_18 {
    ...
    function shouldDeductFee(
        ...
        IVault_0_8_18 vault = IVault_0_8_18(_vault);
    ...
    function increasePosition(
        ...
        uint256 markPrice = _isLong ? IVault_0_8_18(_vault).getMaxPrice(_indexToken) : IVault_0_8_18(_vault).getMinPrice(_indexToken);
        if (_isLong) {
        ...
        IShortsTracker_0_8_18(_shortsTracker).updateGlobalShortData(_account, _collateralToken, _indexToken, _isLong, _sizeDelta, markPrice, true);

        ITimelock_0_8_18(timelock).enableLeverage(_vault);
        IRouter_0_8_18(_router).pluginIncreasePosition(_account, _collateralToken, _indexToken, _sizeDelta, _isLong);
