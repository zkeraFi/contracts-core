...
describe("migrateVesterV1ToV2", () => {
    let vesterV0,vesterV1, vesterV2, zke, usdc, owner, user1, user2;
    ...
    beforeEach(async () => {
        ...
        await zke.transfer(vesterV1.address, MAX_ZKE_VESTING);
    ...
    it("bug reproduce on weeklyVesting V1", async () => {
        ...
        await user1WeeklyVesting.buyTokens(parseEther("40000")); // User1 buys 40000 ZKE tokens
        ...
        const expectedAvailableZke = claimPerWeek.eq(availableTokens);
