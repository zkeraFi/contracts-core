...
describe("Vault.decreaseShortPosition", function () {
  ...
  it("decreasePosition short", async () => {
    ...
    expect(await zlpManager.getAumInUsdg(true), "aum max 1").eq("99960000000000000000") // 102.21
  ...
  it("decreasePosition short minProfitBasisPoints", async () => {
    ...
    expect(await zlpManager.getAumInUsdg(true), "aum max 5").eq("99960000000000000000") // 102.21
  ...
  it("decreasePosition short with loss", async () => {
    ...
    expect(await zlpManager.getAumInUsdg(true), "aum max 7").eq("99960000000000000000") // 102.21
